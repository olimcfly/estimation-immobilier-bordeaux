...
<h3 style="margin-top:0;">Nouvelle estimation</h3>
<p><strong>Adresse :</strong> <?php echo htmlspecialchars((string) ($data['adresse'] ?? '-'), ENT_QUOTES, 'UTF-8'); ?></p>
<p><strong>Type :</strong> <?php echo htmlspecialchars((string) ($data['type_bien'] ?? '-'), ENT_QUOTES, 'UTF-8'); ?></p>
<p><strong>Surface :</strong> <?php echo (int) ($data['surface'] ?? 0); ?> m²</p>
<p><strong>Prix estimé :</strong> <?php echo number_format((float) ($data['prix_estime'] ?? 0), 0, ',', ' '); ?> €</p>
<p><strong>Score :</strong> <?php echo (int) ($data['lead_score'] ?? 0); ?>/100</p>
<p style="margin-top:24px;"><a href="<?php echo htmlspecialchars($siteUrl . '/admin/lead.php?id=' . (int) ($data['id'] ?? 0), ENT_QUOTES, 'UTF-8'); ?>" style="background:<?php echo htmlspecialchars($siteColor, ENT_QUOTES, 'UTF-8'); ?>;color:#fff;text-decoration:none;padding:12px 20px;border-radius:8px;display:inline-block;font-weight:600;">Voir la fiche lead →</a></p>
</td></tr>
