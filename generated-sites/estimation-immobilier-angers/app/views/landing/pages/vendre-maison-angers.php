<?php
/**
 * Landing Page Google Ads — Mot-clé : "vendre maison angers"
 */
  ...
  <div class="lp-container lp-hero-grid">
    ...
    <div class="lp-hero-content">
      ...
      <div class="lp-social-proof-mini">
        ...
        <span>4.8/5 — Des centaines de propriétaires de angers nous font confiance</span>
      </div>
    </div>
    ...
    <div class="lp-form-card">
      ...
      <form action="/lp/submit" method="post" class="lp-form" id="lp-form">
        <input type="hidden" name="landing_slug" value="<?= e((string) ($landing_slug ?? 'vendre-maison-angers')) ?>">
        ...
        <div class="lp-field">
          ...
          <input type="text" id="ville" name="ville" value="Angers" placeholder="Caudéran, Talence, Pessac...">
        </div>
  ...
  <div class="lp-container">
    ...
    <div class="lp-benefits-grid">
      ...
      <div class="lp-benefit-card">
        ...
        <p>Nous connaissons chaque quartier de Angers : Chartrons, Caudéran, Saint-Pierre, Bastide, Mériadeck...</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="lp-container">
    ...
    <div class="lp-faq">
      <details class="lp-faq-item" open>
        ...
        <p>Le prix moyen d'une maison à Angers varie entre 3 500 et 6 000 €/m² selon le quartier. Caudéran et les Chartrons sont parmi les quartiers les plus prisés, tandis que la Bastide offre encore des opportunités intéressantes.</p>
      </details>
...
<section class="lp-section lp-cta-section">
  <div class="lp-container lp-cta-content">
    ...
    <p>Commencez par une estimation gratuite. Un expert de angers vous accompagne ensuite.</p>
