<?php
/**
 * Landing Page Google Ads — Mot-clé : "avis de valeur gratuit angers"
 */
  ...
  <div class="lp-container lp-hero-grid">
    ...
    <div class="lp-hero-content">
      ...
      <div class="lp-social-proof-mini">
        ...
        <span>4.8/5 — Service noté par nos clients de angers</span>
      </div>
    </div>
    ...
    <div class="lp-form-card">
      ...
      <form action="/lp/submit" method="post" class="lp-form" id="lp-form">
        ...
        <div class="lp-field">
          ...
          <input type="text" id="ville" name="ville" value="Angers" placeholder="Angers, Mérignac, Talence...">
        </div>
  ...
  <div class="lp-container">
    ...
    <div class="lp-steps">
      ...
      <div class="lp-step">
        ...
        <p>Recevez une première fourchette de prix basée sur les données du marché de angers.</p>
      </div>
      <div class="lp-step-arrow"><i class="fas fa-chevron-right"></i></div>
      <div class="lp-step">
  ...
  <div class="lp-container">
    ...
    <div class="lp-testimonials">
      <div class="lp-testimonial">
        ...
        <p class="lp-testimonial-author"><strong>Catherine V.</strong> — Angers Bastide</p>
      </div>
      <div class="lp-testimonial">
        <div class="lp-testimonial-stars">
          <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
...
<section class="lp-section lp-cta-section">
  <div class="lp-container lp-cta-content">
    ...
    <p>Sans engagement. Un expert de angers affine votre estimation sous 24h.</p>
