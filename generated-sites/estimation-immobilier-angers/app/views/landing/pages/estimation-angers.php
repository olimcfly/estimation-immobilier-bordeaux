<?php
/**
 * Landing Page Google Ads — Mot-clé : "estimation immobilière angers"
 *
  ...
  <div class="lp-container lp-hero-grid">
    ...
    <div class="lp-hero-content">
      ...
      <p class="lp-lead">
        ...
        Basé sur les données réelles du marché de angers. <strong>100% gratuit</strong>, sans engagement.
      </p>
    ...
    <div class="lp-form-card">
      ...
      <form action="/lp/submit" method="post" class="lp-form" id="lp-form">
        ...
        <div class="lp-field">
          ...
          <input type="text" id="ville" name="ville" value="Angers" placeholder="Angers, Chartrons, Caudéran...">
        </div>
  ...
  <div class="lp-container">
    ...
    <div class="lp-benefits-grid">
      <div class="lp-benefit-card">
        ...
        <p>Notre algorithme analyse les transactions récentes et les prix au m² actuels de chaque quartier de angers.</p>
      </div>
      <div class="lp-benefit-card">
  ...
  <div class="lp-container">
    ...
    <div class="lp-steps">
      ...
      <div class="lp-step">
        ...
        <p>Notre algorithme calcule une fourchette de prix basée sur les données réelles du marché de angers.</p>
      </div>
      <div class="lp-step-arrow"><i class="fas fa-chevron-right"></i></div>
      <div class="lp-step">
  ...
  <div class="lp-container">
    ...
    <div class="lp-testimonials">
      <div class="lp-testimonial">
        ...
        <p class="lp-testimonial-author"><strong>Marie D.</strong> — Angers Chartrons</p>
      </div>
      <div class="lp-testimonial">
        <div class="lp-testimonial-stars">
          <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
        ...
        <p class="lp-testimonial-author"><strong>Pierre L.</strong> — Angers Saint-Pierre</p>
      </div>
      <div class="lp-testimonial">
        <div class="lp-testimonial-stars">
          <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
