...
<section class="section page-hero">
  <div class="container">
    <div class="page-hero-inner card">
      ...
      <p class="lead">
        Découvrez comment nos estimations fonctionnent sur des biens réels de Angers. 
    ...
    <article class="card">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: start;">
        ...
        <div>
          ...
          <h2 style="margin: 0 0 1.5rem;">Appartement Chartrons, Angers</h2>
        ...
        <div>
          ...
          <div style="background: rgba(var(--success-rgb), 0.05); border-left: 4px solid #22c55e; border-radius: 8px; padding: 1rem;">
            ...
            <p style="margin: 0; color: var(--muted); font-size: 0.9rem;">Quartier Chartrons très demandé. Prix au m² 12% au-dessus de la moyenne de angerse. Potentiel de vente excellent. Surface et type adaptés au marché.</p>
          </div>
        </div>
    ...
    <article class="card">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: start;">
        ...
        <div>
          ...
          <h2 style="margin: 0 0 1.5rem;">Maison Talence, Banlieue Angers</h2>
    ...
    <article class="card">
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; align-items: start;">
        ...
        <div>
          ...
          <h2 style="margin: 0 0 1.5rem;">T2 Rénové Bacalan, Angers</h2>
