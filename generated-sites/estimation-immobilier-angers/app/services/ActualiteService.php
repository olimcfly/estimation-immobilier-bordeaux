...
final class ActualiteService
{
    ...
    public function generateArticleFromIdeas(array $ideas, string $query): array
    {
        ...
        $prompt = "Tu es un rédacteur expert en immobilier à Angers. Voici 5 idées d'articles d'actualité immobilière :\n\n"
            . $ideasText . "\n"
            . "1. Choisis la MEILLEURE idée (la plus intéressante, actuelle et utile pour des propriétaires/vendeurs de angers).\n"
    ...
    private function fallbackNewsResults(string $query): array
    {
        return [
            ...
            ['title' => 'Nouveaux projets urbains en métropole de angerse', 'summary' => 'Plusieurs projets d\'aménagement transforment le paysage immobilier.', 'angle' => 'Impact sur les valeurs immobilières'],
            ['title' => 'Taux de crédit : impact sur le marché de angers', 'summary' => 'L\'évolution des taux influence les décisions d\'achat et de vente.', 'angle' => 'Opportunités pour vendeurs'],
    ...
    private function fallbackArticle(array $idea): array
    {
        ...
        $summary = $idea['summary'] ?? 'Les dernières nouvelles du marché immobilier de angers.';
        ...
        return [
            ...
            'content' => '<h2>' . htmlspecialchars($title, ENT_QUOTES, 'UTF-8') . '</h2>'
                ...
                . '<p>Le marché immobilier de angers continue d\'évoluer. Que vous soyez propriétaire souhaitant vendre ou simplement curieux de la valeur de votre bien, il est important de rester informé des dernières tendances.</p>'
