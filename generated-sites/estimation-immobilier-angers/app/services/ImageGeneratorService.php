...
final class ImageGeneratorService
{
    ...
    public function generateSeoPrompt(string $type, string $quartier = '', string $style = ''): string
    {
        ...
        $prompts = [
            'estimation' => "Photo professionnelle immobilière d'une belle propriété {$style} dans le quartier {$quartier} à Angers. Vue extérieure avec façade en pierre de angerse typique, lumière naturelle dorée du soleil couchant, végétation soignée. Style éditorial haut de gamme pour agence immobilière.",
            'interieur' => "Photo d'intérieur immobilier professionnel, salon {$style} dans un appartement de angers haussmannien, parquet en point de Hongrie, hauts plafonds avec moulures, grandes fenêtres lumineuses. Décoration épurée et chaleureuse. Photographie immobilière éditoriale.",
            ...
            'blog' => "Illustration éditoriale pour blog immobilier, concept de l'estimation immobilière à Angers. Maison de angerse en pierre avec une loupe ou des éléments graphiques subtils représentant l'analyse de marché. Style professionnel et moderne.",
            'cta' => "Image d'appel à l'action pour site immobilier, couple souriant devant une belle maison de angerse {$style}, ambiance positive et professionnelle. Espace pour superposition de texte. Photographie lifestyle immobilier.",
        ];
