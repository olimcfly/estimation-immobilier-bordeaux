    ...
    private const NEUROPERSONAS = [
        'analytique' => [
            ...
            'article_topics' => [
                ...
                'Analyse comparative du march&eacute; immobilier de angers',
        ...
        'expressif' => [
            ...
            'article_topics' => [
                'Coup de coeur : les plus beaux quartiers de Angers',
                'T&eacute;moignages de nos clients satisfaits',
                'Vivre &agrave; Angers : un art de vivre unique',
                'Les p&eacute;pites cach&eacute;es du march&eacute; de angers',
            ],
        ],
        'directif' => [
            'label' => 'Directif',
