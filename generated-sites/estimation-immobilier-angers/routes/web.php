...
$router->get('/lp/estimation-angers', [LandingPageController::class, 'estimationAngers']);
$router->get('/lp/vendre-maison-angers', [LandingPageController::class, 'vendreMaisonAngers']);
