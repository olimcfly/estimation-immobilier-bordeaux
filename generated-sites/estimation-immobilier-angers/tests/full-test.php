...
$hosts = [
    'mail1.o2switch.net',
    'mail.estimation-immobilier-angers.fr',
    'estimation-immobilier-angers.fr',
];
...
$mailFrom = $_ENV['MAIL_FROM_ADDRESS'] ?? $_ENV['MAIL_FROM'] ?? 'contact@estimation-immobilier-angers.fr';
