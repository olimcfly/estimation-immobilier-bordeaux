<?php $page_title = 'Contact - Estimation Immobilière Nantes | Nous Sommes Disponibles'; ?>
...
<section class="section page-hero">
  <div class="container">
    <div class="page-hero-inner card">
      ...
      <p class="lead">
        Besoin d'un avis expert ? Des questions sur une estimation ? Notre équipe de nantese est disponible pour vous accompagner.
      </p>
    </div>
  </div>
</section>
        ...
        <div class="info-block">
          ...
          <p class="info-value">
            <a href="mailto:contact@estimation-immobilier-nantes.fr">
              contact@estimation-immobilier-nantes.fr
            </a>
          </p>
          <p class="info-desc">
        ...
        <form class="form-grid form-contact" action="/contact" method="post">
          ...
          <div class="form-checkbox full-width">
            ...
            <label for="rgpd" style="margin: 0; font-weight: 500; font-size: 0.9rem; color: var(--text); cursor: pointer;">
              ...
              et je consens à recevoir des communications de la part d'Estimation Nantes *
            </label>
          </div>
  ...
  <div class="container">
    ...
    <div class="service-grid">
      ...
      <article class="card service-additional">
        ...
        <a href="mailto:contact@estimation-immobilier-nantes.fr" class="btn btn-small" style="margin-top: 1rem;">
      ...
      <article class="card service-additional">
        ...
        <p>
          ...
          avec nos experts au siège à Nantes.
        </p>
        <button class="btn btn-small" style="margin-top: 1rem; cursor: pointer;">
  ...
  <div class="container">
    ...
    <div class="faq-grid">
      ...
      <article class="card faq-card">
        ...
        <p>
          Oui ! Sur rendez-vous. 12 Quai des Chartrons, Nantes. 
