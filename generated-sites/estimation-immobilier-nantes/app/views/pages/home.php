<?php $page_title = 'Estimation Immobilier Nantes | Avis de Valeur Gratuit'; ?>
<?php $meta_description = 'Obtenez une fourchette de prix indicative gratuite pour votre bien immobilier à Nantes en 60 secondes. 3 informations suffisent. 100% gratuit, sans engagement.'; ?>
...
<section class="hero">
  <div class="container hero-grid">
    ...
    <div>
      ...
      <h1>Estimez la valeur de votre bien immobilier à Nantes</h1>
      ...
      <div style="margin-top: 2rem; padding: 1.2rem; background: rgba(var(--primary-rgb), 0.04); border-radius: 12px; border-left: 3px solid var(--primary);">
        ...
        <p style="margin: 0; font-style: italic; color: var(--text); line-height: 1.6;">
          "L'avis de valeur était très proche de l'offre reçue. Recommandé pour avoir une estimation fiable avant de vendre à Nantes !"
        </p>
        <p style="margin: 0.8rem 0 0; font-size: 0.85rem; color: var(--muted); font-weight: 600;">
          — Marie D. • Nantes Chartrons
        </p>
      </div>
    ...
    <aside class="hero-panel card" id="form-estimation">
      ...
      <form action="/estimation" method="post" class="form-grid">
        ...
        <label for="ville">
          ...
          <input
            ...
            id="ville"
            name="ville"
            placeholder="Nantes, Talence, Mérignac..."
            required
            autocomplete="off"
          >
        </label>
      ...
      <div style="padding: 1.5rem;">
        <ul style="list-style: none; padding: 0; margin: 0 0 1.5rem;">
          ...
          <li style="margin-bottom: 1rem; display: flex; align-items: center; gap: 0.75rem;">
            <i class="fas fa-check-circle" style="color: var(--primary); font-size: 1.2rem;"></i>
            <span><strong>Données réelles</strong> — 5000+ transactions en Loire-Atlantique</span>
          </li>
