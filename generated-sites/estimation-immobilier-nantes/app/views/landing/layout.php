...
<head>
  ...
  <title><?= e((string) ($page_title ?? 'Estimation Immobilier Nantes')) ?></title>
...
<body class="lp-body">
  ...
  <?php
    ...
    $landingViewPath = __DIR__ . '/../' . ($landing_view ?? 'landing/pages/estimation-nantes') . '.php';
    ...
    <div class="lp-container">
      <div class="lp-footer-inner">
        <div class="lp-footer-brand">
          ...
          <span class="lp-logo-text">Estimation Immobilier <strong>Nantes</strong></span>
        </div>
        ...
        <p class="lp-footer-copy">&copy; <?= date('Y') ?> Estimation Immobilier Nantes. Tous droits réservés.</p>
      </div>
    </div>
  </footer>
