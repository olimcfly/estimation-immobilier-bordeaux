<?php
/**
 * Landing Page Google Ads — Mot-clé : "estimation immobilière nantes"
 *
...
<section class="lp-hero">
  <div class="lp-container lp-hero-grid">
    ...
    <div class="lp-hero-content">
      ...
      <h1>Estimation Immobilière <span class="lp-highlight">Nantes</span> — Gratuite en 60 secondes</h1>

      <p class="lp-lead">
        Obtenez une <strong>fourchette de prix fiable</strong> pour votre bien immobilier à Nantes.
        Basé sur les données réelles du marché de nantes. <strong>100% gratuit</strong>, sans engagement.
      </p>
      ...
      <ul class="lp-trust-list">
        ...
        <li><i class="fas fa-chart-bar"></i> <strong>Marché actuel</strong> — prix réels Nantes 2024</li>
      </ul>
      ...
      <div class="lp-social-proof-mini">
        ...
        <span>4.8/5 — Plus de <strong>2 400 estimations</strong> réalisées à Nantes</span>
      </div>
    </div>
    ...
    <div class="lp-form-card">
      ...
      <form action="/lp/submit" method="post" class="lp-form" id="lp-form">
        <input type="hidden" name="landing_slug" value="<?= e((string) ($landing_slug ?? 'estimation-nantes')) ?>">
        ...
        <div class="lp-field">
          ...
          <input type="text" id="ville" name="ville" value="Nantes" placeholder="Nantes, Chartrons, Caudéran...">
        </div>
...
<section class="lp-section">
  <div class="lp-container">
    <div class="lp-section-heading">
      ...
      <h2>L'estimation immobilière la plus fiable de <span class="lp-highlight">Nantes</span></h2>
    </div>
    ...
    <div class="lp-benefits-grid">
      <div class="lp-benefit-card">
        ...
        <p>Notre algorithme analyse les transactions récentes et les prix au m² actuels de chaque quartier de nantes.</p>
      </div>
      <div class="lp-benefit-card">
  ...
  <div class="lp-container">
    ...
    <div class="lp-steps">
      ...
      <div class="lp-step">
        ...
        <p>Notre algorithme calcule une fourchette de prix basée sur les données réelles du marché de nantes.</p>
      </div>
      <div class="lp-step-arrow"><i class="fas fa-chevron-right"></i></div>
      <div class="lp-step">
...
<section class="lp-section">
  <div class="lp-container">
    <div class="lp-section-heading">
      ...
      <h2>Ce que disent nos clients à Nantes</h2>
    </div>
    ...
    <div class="lp-testimonials">
      <div class="lp-testimonial">
        ...
        <p class="lp-testimonial-author"><strong>Marie D.</strong> — Nantes Chartrons</p>
      </div>
      <div class="lp-testimonial">
        <div class="lp-testimonial-stars">
          <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
        ...
        <p class="lp-testimonial-author"><strong>Pierre L.</strong> — Nantes Saint-Pierre</p>
      </div>
      <div class="lp-testimonial">
        <div class="lp-testimonial-stars">
          <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half-alt"></i>
...
<section class="lp-section lp-section-alt">
  <div class="lp-container">
    <div class="lp-section-heading">
      ...
      <h2>Tout savoir sur l'estimation immobilière à Nantes</h2>
    </div>
    ...
    <div class="lp-faq">
      ...
      <details class="lp-faq-item">
        ...
        <p>Notre algorithme analyse les transactions immobilières récentes à Nantes, les prix au m² par quartier, le type de bien et sa surface pour vous fournir une fourchette de prix réaliste.</p>
      </details>
      <details class="lp-faq-item">
...
<section class="lp-section lp-cta-section">
  <div class="lp-container lp-cta-content">
    ...
    <p class="lp-cta-sub">Plus de 2 400 estimations réalisées à Nantes</p>
  </div>
</section>
