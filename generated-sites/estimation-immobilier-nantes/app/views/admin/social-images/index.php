  ...
  var templates = {
    estimation: {
      fields: [
        ...
        { id: 'quartier', label: 'Quartier', type: 'select', options: ['Nantes Centre', <?php foreach ($quartiers as $q): ?>'<?= $q ?>',<?php endforeach; ?>], value: 'Nantes Centre' },
        { id: 'badge', label: 'Badge', type: 'text', value: 'ESTIMATION GRATUITE' },
        { id: 'brand', label: 'Marque', type: 'text', value: 'estimation-immobilier-nantes.fr' },
      ...
      render: function(v) {
        return '<div class="social-card tpl-estimation" style="background:linear-gradient(135deg,' + v.bg1 + ' 0%,' + v.bg2 + ' 100%);">' +
          ...
          '<div class="city">Nantes &mdash; Pays de la Loire</div>' +
    ...
    conseil: {
      fields: [
        ...
        { id: 'brand', label: 'Marque', type: 'text', value: 'Estimation Immobilier Nantes' },
        { id: 'url', label: 'URL', type: 'text', value: 'estimation-immobilier-nantes.fr' },
    ...
    stat: {
      fields: [
        { id: 'label', label: 'Label', type: 'text', value: 'MARCH\u00c9 IMMOBILIER NANTES' },
        { id: 'value', label: 'Chiffre', type: 'text', value: '+12%' },
        { id: 'unit', label: 'Unit\u00e9', type: 'text', value: 'en 2 ans' },
        { id: 'desc', label: 'Description', type: 'textarea', value: 'Les prix de l\u2019immobilier \u00e0 Nantes ont progress\u00e9 de 12% sur les deux derni\u00e8res ann\u00e9es.' },
        { id: 'brand', label: 'Marque', type: 'text', value: 'estimation-immobilier-nantes.fr' },
    ...
    story: {
      fields: [
        ...
        { id: 'title', label: 'Titre', type: 'text', value: 'Combien vaut votre bien \u00e0 Nantes ?' },
    ...
    paysage: {
      fields: [
        ...
        { id: 'title', label: 'Titre', type: 'text', value: 'Estimez votre bien immobilier \u00e0 Nantes' },
