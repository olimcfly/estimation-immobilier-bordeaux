...
<head>
  ...
  <meta name="description" content="<?= htmlspecialchars((string) ($meta_description ?? 'Estimation immobilier Nantes - Obtenez votre avis de valeur immobilier gratuit. Données réelles du marché de nantes, résultat en 60 secondes.'), ENT_QUOTES, 'UTF-8') ?>">
  <meta name="theme-color" content="#8B1538">
  <link rel="icon" type="image/svg+xml" href="/favicon.svg">
  <link rel="canonical" href="<?= e($canonicalUrl) ?>">
  <title><?= isset($page_title) ? $page_title : 'Estimation Immobilier Nantes' ?></title>

  <!-- Open Graph -->
  <meta property="og:type" content="website">
  <meta property="og:title" content="<?= isset($page_title) ? htmlspecialchars($page_title, ENT_QUOTES, 'UTF-8') : 'Estimation Immobilier Nantes' ?>">
  <meta property="og:description" content="<?= htmlspecialchars((string) ($meta_description ?? 'Obtenez votre avis de valeur immobilier gratuit à Nantes. Résultat en 60 secondes.'), ENT_QUOTES, 'UTF-8') ?>">
  <meta property="og:url" content="<?= e($canonicalUrl) ?>">
  <meta property="og:locale" content="fr_FR">
  <meta property="og:site_name" content="Estimation Immobilier Nantes">
  <meta property="og:image" content="https://estimation-immobilier-nantes.fr/assets/images/og-estimation-nantes.png">
  <meta property="og:image:width" content="1200">
  <meta property="og:image:height" content="630">

  <!-- Twitter Card -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="<?= isset($page_title) ? htmlspecialchars($page_title, ENT_QUOTES, 'UTF-8') : 'Estimation Immobilier Nantes' ?>">
  <meta name="twitter:description" content="<?= htmlspecialchars((string) ($meta_description ?? 'Avis de valeur immobilier gratuit à Nantes. Résultat en 60 secondes.'), ENT_QUOTES, 'UTF-8') ?>">
  <meta name="twitter:image" content="https://estimation-immobilier-nantes.fr/assets/images/og-estimation-nantes.png">
  ...
  <script type="application/ld+json">
  {
    ...
    "name": "Estimation Immobilier Nantes",
    "description": "Avis de valeur et estimation immobilière gratuite à Nantes et en Loire-Atlantique.",
    "url": "https://estimation-immobilier-nantes.fr",
    "telephone": "+33240000000",
    "email": "contact@estimation-immobilier-nantes.fr",
    "address": {
      "@type": "PostalAddress",
...
<header class="site-header">
  <div class="container nav-wrapper">
    <a href="/" class="brand">Estimation Immobilier <span>Nantes</span></a>
    ...
    <nav class="top-nav" aria-label="Navigation principale">
      ...
      <div class="nav-item has-dropdown">
        ...
        <ul class="dropdown-menu" aria-label="Sous-menu ressources">
          ...
          <li><a href="/quartiers">Quartiers Nantes</a></li>
