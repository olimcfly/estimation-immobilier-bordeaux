  ...
  <div class="container">
    ...
    <div class="footer-grid">
      ...
      <div class="footer-column footer-col-brand">
        <a href="/" class="footer-logo-link">
          ...
          <span class="footer-logo-text">Estimation Immobilier <strong>Nantes</strong></span>
        </a>
        <p class="footer-desc">
          Votre partenaire de confiance pour l'estimation immobilière sur Nantes et la métropole de nantese depuis 2020.
        </p>
        <div class="footer-social">
          <a href="https://facebook.com/estimation-nantes" target="_blank" rel="noopener noreferrer" title="Facebook" class="social-icon"><i class="fab fa-facebook-f"></i></a>
          <a href="https://instagram.com/estimation-nantes" target="_blank" rel="noopener noreferrer" title="Instagram" class="social-icon"><i class="fab fa-instagram"></i></a>
          <a href="https://linkedin.com/company/estimation-nantes" target="_blank" rel="noopener noreferrer" title="LinkedIn" class="social-icon"><i class="fab fa-linkedin-in"></i></a>
      ...
      <div class="footer-column">
        ...
        <ul class="footer-links">
          ...
          <li><a href="/quartiers">Quartiers de Nantes</a></li>
      ...
      <div class="footer-column">
        ...
        <ul class="footer-contact">
          <li>
            ...
            <span>Nantes, 44000<br>Pays de la Loire</span>
          </li>
          <li>
          ...
          <li>
            <a href="mailto:contact@estimation-immobilier-nantes.fr">
              <i class="fas fa-envelope"></i>
              <span>contact@estimation-immobilier-nantes.fr</span>
            </a>
          </li>
        </ul>
      </div>
    ...
    <div class="footer-newsletter-band">
      <div class="footer-newsletter-text">
        ...
        <div>
          ...
          <span>Recevez nos analyses du marché de nantes et nos conseils immobiliers.</span>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="footer-bottom-left">
        <p>&copy; 2026 Estimation Immobilier Nantes &mdash; SAS OCDM Agency. Tous droits réservés.</p>
      </div>
