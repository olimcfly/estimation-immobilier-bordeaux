...
final class ImageGeneratorService
{
    ...
    {
        $quartier = $quartier !== '' ? $quartier : 'Nantes centre';
        $style = $style !== '' ? $style : 'moderne et lumineux';

        $prompts = [
            'estimation' => "Photo professionnelle immobilière d'une belle propriété {$style} dans le quartier {$quartier} à Nantes. Vue extérieure avec façade en pierre de nantese typique, lumière naturelle dorée du soleil couchant, végétation soignée. Style éditorial haut de gamme pour agence immobilière.",
            'interieur' => "Photo d'intérieur immobilier professionnel, salon {$style} dans un appartement de nantes haussmannien, parquet en point de Hongrie, hauts plafonds avec moulures, grandes fenêtres lumineuses. Décoration épurée et chaleureuse. Photographie immobilière éditoriale.",
            'quartier' => "Vue panoramique du quartier {$quartier} à Nantes, architecture typique en pierre blonde, rues piétonnes animées, terrasses de cafés. Ambiance chaleureuse et authentique du Sud-Ouest. Photographie urbaine professionnelle.",
            'blog' => "Illustration éditoriale pour blog immobilier, concept de l'estimation immobilière à Nantes. Maison de nantese en pierre avec une loupe ou des éléments graphiques subtils représentant l'analyse de marché. Style professionnel et moderne.",
            'cta' => "Image d'appel à l'action pour site immobilier, couple souriant devant une belle maison de nantese {$style}, ambiance positive et professionnelle. Espace pour superposition de texte. Photographie lifestyle immobilier.",
        ];
