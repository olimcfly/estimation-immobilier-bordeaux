    ...
    private const NEUROPERSONAS = [
        'analytique' => [
            ...
            'article_topics' => [
                ...
                'Analyse comparative du march&eacute; immobilier de nantes',
        ...
        'expressif' => [
            ...
            'article_topics' => [
                'Coup de coeur : les plus beaux quartiers de Nantes',
                'T&eacute;moignages de nos clients satisfaits',
                'Vivre &agrave; Nantes : un art de vivre unique',
                'Les p&eacute;pites cach&eacute;es du march&eacute; de nantes',
            ],
        ],
        'directif' => [
            'label' => 'Directif',
            ...
            'article_topics' => [
                'Guide express : acheter &agrave; Nantes en 30 jours',
                'Les 5 erreurs &agrave; &eacute;viter lors d\'un achat immobilier',
                'Checklist : les &eacute;tapes cl&eacute;s de votre projet',
                'Investir &agrave; Nantes : les opportunit&eacute;s &agrave; saisir maintenant',
            ],
        ],
        'aimable' => [
            'label' => 'Aimable',
