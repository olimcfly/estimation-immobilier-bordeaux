...
final class AuthController
{
    public function loginForm(): void
    {
        ...
        View::renderBare('admin/login', [
            'page_title' => 'Connexion Admin - Estimation Immobilier Nantes',
            'step' => 'email',
    ...
    private function handleSendCode(): void
    {
        ...
        $sent = Mailer::send(
            $email,
            'Votre code de connexion - Estimation Immobilier Nantes',
    ...
    private function buildCodeEmail(string $code, string $name): string
    {
        ...
        <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 500px; margin: 0 auto; padding: 2rem;">
            ...
            <p style="text-align: center; color: #999; font-size: 0.8rem;">Estimation Immobilier Nantes</p>
        </div>
        HTML;
    }
    ...
    public function testSmtpSendEmail(): void
    {
        ...
        $subject = 'Test SMTP - Estimation Immobilier Nantes';
