...
final class PageController
{
    public function home(): void
    {
        View::render('pages/home', [
            'page_title' => 'Accueil - Estimation Immobilier Nantes',
        ]);
    }
    ...
    public function services(): void
    {
        View::render('pages/services', [
            'page_title' => 'Nos Services - Estimation Immobilier Nantes',
        ]);
    }
    ...
    public function about(): void
    {
        View::render('pages/a_propos', [
            'page_title' => 'À Propos - Estimation Immobilier Nantes',
        ]);
    }
    ...
    public function processusEstimation(): void
    {
        View::render('pages/processus_estimation', [
            'page_title' => 'Processus d\'Estimation - Estimation Immobilier Nantes',
        ]);
    }
    ...
    public function newsletter(): void
    {
        View::render('pages/newsletter', [
            'page_title' => 'Newsletter - Estimation Immobilier Nantes',
        ]);
    }
    ...
    public function guides(): void
    {
        View::render('pages/guides', [
            'page_title' => 'Guides Immobiliers Nantes - Conseils & Astuces',
        ]);
    }
    ...
    public function exemplesEstimation(): void
    {
        View::render('pages/exemples_estimation', [
            'page_title' => "Exemple Estimation - Cas Réels Nantes | Nos Résultats",
        ]);
    }
    ...
    public function quartiers(): void
    {
        View::render('pages/quartiers', [
            'page_title' => 'Quartiers de Nantes - Estimation Immobilier Nantes',
        ]);
    }
    ...
    public function contact(): void
    {
        View::render('pages/contact', [
            'page_title' => 'Contact - Estimation Immobilier Nantes',
        ]);
    }
    ...
    public function mentionsLegales(): void
    {
        View::render('legal/mentions', [
            'page_title' => 'Mentions légales - Estimation Immobilier Nantes',
        ]);
    }
    ...
    public function politiqueConfidentialite(): void
    {
        View::render('legal/confidentialite', [
            'page_title' => 'Politique de confidentialité - Estimation Immobilier Nantes',
        ]);
    }
    ...
    public function conditionsUtilisation(): void
    {
        View::render('legal/cgu', [
            'page_title' => 'Conditions d\'utilisation - Estimation Immobilier Nantes',
        ]);
    }
    ...
    public function rgpd(): void
    {
        View::render('legal/rgpd', [
            'page_title' => 'RGPD - Estimation Immobilier Nantes',
        ]);
    }
