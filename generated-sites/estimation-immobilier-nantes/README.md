# Estimation Immobilier Nantes (PHP MVC)

Application SaaS d'estimation immobilière pour **Nantes et ses alentours** en **PHP 8+**, architecture MVC légère, **MySQL (PDO)**.
...
- Guide des quartiers de nantes avec carte interactive
...
- `GET /quartiers` → guide des quartiers de nantes
