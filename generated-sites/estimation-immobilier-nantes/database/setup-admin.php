 ...
 *   ADMIN_EMAIL - Admin email (default: contact@estimation-immobilier-nantes.fr)
 */
...
$email = $argv[1] ?? $_ENV['ADMIN_EMAIL'] ?? 'contact@estimation-immobilier-nantes.fr';
...
echo "\nSetup terminé !\n";
echo "Connectez-vous sur : https://estimation-immobilier-nantes.fr/admin/login\n";
