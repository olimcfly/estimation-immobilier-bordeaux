...
return [
    ...
    'db' => [
        ...
        'name' => $_ENV['DB_NAME'] ?? 'immobilier_nantes',
    ...
    'mail' => [
        'from' => $_ENV['MAIL_FROM_ADDRESS'] ?? $_ENV['MAIL_FROM'] ?? 'contact@estimation-immobilier-nantes.fr',
        'from_name' => $_ENV['MAIL_FROM_NAME'] ?? 'Estimation Immobilier Nantes',
        'admin_email' => $_ENV['MAIL_ADMIN_EMAIL'] ?? $_ENV['MAIL_FROM_ADDRESS'] ?? $_ENV['MAIL_FROM'] ?? 'contact@estimation-immobilier-nantes.fr',
