...
$router->get('/lp/estimation-nantes', [LandingPageController::class, 'estimationNantes']);
$router->get('/lp/vendre-maison-nantes', [LandingPageController::class, 'vendreMaisonNantes']);
