...
final class ActualiteServiceTest extends TestCase
{
    ...
    {
        $result = $this->service->searchNews('prix immobilier Nantes 2026');

        $this->assertSame('prix immobilier Nantes 2026', $result['query']);
    ...
    {
        $ideas = [
            ['title' => 'Marché immobilier Nantes', 'summary' => 'Les prix évoluent', 'angle' => 'Analyse'],
        ];
    ...
    public function testCronScriptSlugify(): void
    {
        ...
        $this->assertSame('estimation-immobilière-nantes', cronSlugify('Estimation Immobilière Nantes'));
