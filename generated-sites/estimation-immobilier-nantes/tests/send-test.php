...
$fromAddress    = $_ENV['MAIL_FROM_ADDRESS']      ?? $_ENV['MAIL_FROM']      ?? 'no-reply@estimation-immobilier-nantes.fr';
$fromName       = $_ENV['MAIL_FROM_NAME']         ?? 'Estimation Immobilier Nantes';
...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = "Test SMTP — Estimation Immobilier Nantes ($now)";
    $mail->Body    = <<<HTML
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <p style="margin-top: 20px; color: #6b6459; font-size: 12px;">
            Envoyé depuis le script de test — Estimation Immobilier Nantes
        </p>
    </div>
    HTML;
    $mail->AltBody = "Test SMTP réussi — Estimation Immobilier Nantes\n"
