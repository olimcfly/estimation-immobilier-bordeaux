    ...
    <table class="guide-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><code>/lp/vendre-maison-aix</code></td>
          <td>vendre maison aix, vente maison aix, mettre en vente maison aix</td>
          <td>Capture lead vendeur maison</td>
        </tr>
        <tr>
          <td><strong>Avis de Valeur</strong></td>
          <td><code>/lp/avis-valeur-gratuit</code></td>
          <td>avis de valeur gratuit, avis de valeur aix, estimation gratuite aix</td>
    ...
    <table class="guide-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><code>estimation+immobiliere+aix</code></td>
        </tr>
        <tr>
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            "estimation maison aix"<br>
            "prix immobilier aix"<br>
            [estimation appartement aix]<br>
            "combien vaut ma maison aix"
          </td>
        ...
        <tr>
          <td><strong>Vendre Maison</strong></td>
          <td>
            [vendre maison aix]<br>
            "vendre sa maison aix"<br>
            [vente maison aix]<br>
            "mettre en vente maison aix"<br>
            "prix vente maison aix"
          </td>
        ...
        <tr>
          <td><strong>Avis de Valeur</strong></td>
          <td>
            [avis de valeur aix]<br>
            [avis de valeur gratuit]<br>
            "avis de valeur immobilier aix"<br>
            "estimation gratuite aix"<br>
            [estimation bien immobilier gratuit aix]
          </td>
